...
// Função para esperar a escrita no registrador TWPS do Timer
...
// Função para desabilitar o timer
...
// Configuração inicial dos timers (habilitação do clock)
...
// Função para gerar um delay baseado no timer específico
